...
import {useGetCustomerVehicles} from "../../../ApiService/vehicleQueries";
...
const VehicleListing = () => {
  ...
  const {data: vehicleList, isLoading} = useGetCustomerVehicles(
    vehicleRequest,
  ...
  const columns = [
    ...
    },
    {
      ...
      align: "center",
      render: record => {
        return <p className="email-text">{record}</p>;
      },
    },
    {
      title: "Action",
